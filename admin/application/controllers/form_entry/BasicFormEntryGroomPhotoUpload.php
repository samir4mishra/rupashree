...
class BasicFormEntryGroomPhotoUpload extends NIC_Controller{
	...
	public function index(){
		...
		//$this->load->view('./form_entry/rp_basic_form_entry_groom_photo_upload_view.php');
		$this->load->view($this->config->item('theme') . 'form_entry/rp_basic_form_entry_groom_photo_upload_view');
	}
			...
			{	
				...
				if(copy($photo,$photo_path))
				{
					...
					// Save the image to file and free memory
                		...
                		$this->BasicFormEntryPhotoUpload_model->groom_photo_insert($data);
						
						//redirect('./admin/form_entry/BasicFormEntryDeclarationUpload');
