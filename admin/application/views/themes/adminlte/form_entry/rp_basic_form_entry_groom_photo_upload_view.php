...
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
        	...
        	<div class="box box-success">
            	<div class="box-header with-border">
              		<h3 class="box-title"><strong>Upload Image of Groom</strong></h3>
            	</div>
                    	...
                    	<div class="row">
                            ...
                            <div class="col-sm-6">
                            	<div class="fieldsetdiv" id="tumbnail_blck" style="display:none">
                                	<div class="paneldiv">
							           <div class="brdiv">
									   	<?php echo form_open_multipart('admin/form_entry/BasicFormEntry/save_groom_photo/'); ?>
  ...
  //alert("11111111111");
    ...
    $(function(){
        ...
        var CanvasCrop = $.CanvasCrop({
            cropBox : ".imageBox",
            imgSrc : "<?php echo base_url();?>/admin/assets/image_tool_image/avatar_groom.jpg",
            limitOver : 2
        });
