...
<head>
  ...
  <!-- Extra CSS -->
  <?php /*?><?php foreach($this->css_head as $hcss){ ?>
  ...
  <link rel="stylesheet" href="<?php echo $this->config->item('theme_uri');?>dist/css/skins/_all-skins.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>RUPASHREE</b> Admin</span>
    </a>
